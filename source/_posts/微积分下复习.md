...
$$
\iiint_\Omega f(x,y,z)dv=\int_{\theta_0}^{\theta_1}d\varphi \int_{\theta_0'}^{\theta_1'}d\theta\int_{r_0}^{r_1}f(r\sin \varphi \cos \theta,r\sin \varphi \sin \theta,r \cos \varphi)r^2\sin \varphi dr
$$
